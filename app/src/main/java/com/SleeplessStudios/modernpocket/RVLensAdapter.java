...
public class RVLensAdapter extends RecyclerView.Adapter<RVLensAdapter.ViewHolder> {
    ...
    public RVLensAdapter(ArrayList<DataModal> dataModalArrayList, Context context) {
